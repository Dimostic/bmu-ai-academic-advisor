...
-- ===================== CCMAS Programme Sections =====================
-- Programme-level extraction from large CCMAS documents. These records
-- let retrieval resolve programme + section first, then use vectors for
-- supporting detail.
